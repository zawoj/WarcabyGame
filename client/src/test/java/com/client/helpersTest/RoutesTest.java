...
public class RoutesTest {
    ...
    void testGetImageRoutes() throws MalformedURLException {
        assertEquals(currentRelativePath.toUri().toURL() + "src/main/java/com/client/img/test.png",
    ...
    void testGetStyleRoutes() throws MalformedURLException {
        assertEquals(currentRelativePath.toUri().toURL() + "src/main/java/com/client/styles/test.css",
    ...
    void testGetViewRoutes() throws MalformedURLException {
        assertEquals(new URL(currentRelativePath.toUri().toURL() + "src/main/java/com/client/views/test.fxml"),
